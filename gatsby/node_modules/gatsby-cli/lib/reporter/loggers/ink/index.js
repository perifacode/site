...
var stringWidth_1$2 = stringWidth$3;
// TODO: remove this in the next major version
...
class CLI extends react.Component {
  constructor(...args) {
    ...
    defineProperty(this, "memoizedReactElementsForMessages", []);
  }
  ...
  render() {
    ...
    */
    ...
    if (messages.length > this.memoizedReactElementsForMessages.length) {
      for (let index = this.memoizedReactElementsForMessages.length; index < messages.length; index++) {
        ...
        this.memoizedReactElementsForMessages.push(msg.level === `ERROR` ? /*#__PURE__*/react.createElement(Error$1, {
          details: msg,
          key: index
        }) : /*#__PURE__*/react.createElement(Message, _extends_1({
          key: index
        }, msg)));
      }
    }
    ...
    return /*#__PURE__*/react.createElement(build.Box, {
      ...
      flexDirection: "column"
    }, /*#__PURE__*/react.createElement(build.Static, null, this.memoizedReactElementsForMessages), spinners.map(activity => /*#__PURE__*/react.createElement(Spinner$1, _extends_1({
      key: activity.id
