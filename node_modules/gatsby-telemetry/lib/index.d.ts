import { IAggregateStats, ITelemetryTagsPayload, ITelemetryOptsPayload, IDefaultTelemetryTagsPayload } from "./telemetry";
...
export declare function expressMiddleware(source: string): (_req: Request, _res: Response, next: any) => void;
